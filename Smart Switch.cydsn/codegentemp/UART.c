...
static void UART_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void UART_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[UART_RX_SDA_MOSI_PIN_INDEX] = UART_HSIOM_I2C_SEL;
            hsiomSel[UART_TX_SCL_MISO_PIN_INDEX] = UART_HSIOM_I2C_SEL;
        ...
        {
            hsiomSel[UART_RX_SDA_MOSI_PIN_INDEX] = UART_HSIOM_SPI_SEL;
            hsiomSel[UART_TX_SCL_MISO_PIN_INDEX] = UART_HSIOM_SPI_SEL;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[UART_TX_SCL_MISO_PIN_INDEX] = UART_HSIOM_UART_SEL;
                pinsDm  [UART_TX_SCL_MISO_PIN_INDEX] = UART_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[UART_RX_SDA_MOSI_PIN_INDEX] = UART_HSIOM_UART_SEL;
                    pinsDm  [UART_RX_SDA_MOSI_PIN_INDEX] = UART_PIN_DM_DIG_HIZ;
                }
