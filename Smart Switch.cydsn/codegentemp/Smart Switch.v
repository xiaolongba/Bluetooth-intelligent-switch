...
module top ;
	...
	wire [0:0] tmpFB_0__Button4_net;
	wire [0:0] tmpIO_0__Button4_net;
	electrical [0:0] tmpSIOVREF__Button4_net;

	cy_psoc3_pins_v1_10
		#(.id("8986d366-0795-4636-875f-260f53ea7e4e"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpFB_0__Button3_net;
	wire [0:0] tmpIO_0__Button3_net;
	electrical [0:0] tmpSIOVREF__Button3_net;

	cy_psoc3_pins_v1_10
		#(.id("f9e81d03-c950-4b7e-ae05-cda5d8f878c7"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b11f8c37-8a09-47c0-991a-88e14c8b7694"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
