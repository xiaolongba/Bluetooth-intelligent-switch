...
module top ;
	...
	wire [4:0] tmpOE__Button_net;
	wire [4:0] tmpFB_4__Button_net;
	wire [4:0] tmpIO_4__Button_net;
	...
	cy_psoc3_pins_v1_10
		...
		Button
		 (.oe(tmpOE__Button_net),
		  .y({5'b0}),
		  .fb({tmpFB_4__Button_net[4:0]}),
		  .io({tmpIO_4__Button_net[4:0]}),
	...
	assign tmpOE__Button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{5'b11111} : {5'b11111};
